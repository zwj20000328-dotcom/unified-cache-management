 ...
 */
size_t HIST_count_wksp(unsigned* count, unsigned* maxSymbolValuePtr, const void* src,
 ...
 * *maxSymbolValuePtr`
 */
size_t HIST_countFast(unsigned* count, unsigned* maxSymbolValuePtr, const void* src,
                      size_t srcSize);
 ...
 * `workSpaceSize` must be >= HIST_WKSP_SIZE
 */
size_t HIST_countFast_wksp(unsigned* count, unsigned* maxSymbolValuePtr, const void* src,
                           size_t srcSize, void* workSpace, size_t workSpaceSize);
...
size_t HIST_count_BF16(unsigned* count, unsigned* maxSymbolValuePtr, const void* src,
                       size_t srcSize, void* dst, size_t dstSize, size_t* compressionSize);
...
size_t HIST_lossy_count_FP16(unsigned* count, unsigned* maxSymbolValuePtr, const void* src,
                             size_t srcSize, void* dst, size_t dstCapacity,
