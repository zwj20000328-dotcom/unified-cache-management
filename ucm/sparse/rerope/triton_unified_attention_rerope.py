...
def kernel_unified_attention_2d(
    ...
    query2_offset = (
        query_offset_0[:, None] * query2_stride_0
        + query_offset_1[:, None] * query2_stride_1
        + offs_d[None, :]
    )
    ...
    for j in range(0, num_blocks):
        ...
        k2_offset = (
            physical_block_idx * stride_k_cache2_0
        ...
        K2_load = tl.load(key_cache2_ptr + k2_offset, mask=dim_mask[:, None], other=0.0)
